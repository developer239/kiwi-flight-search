/* https://github.com/zeit/next.js/blob/canary/examples/with-apollo-and-redux/lib/withApollo.js */
...
export default ComposedComponent => class WithData extends React.Component {
    ...
    static propTypes = {
      serverState: PropTypes.object, // eslint-disable-line
    }
    ...
    static async getInitialProps(ctx) {
      ...
      if (!process.browser) {
        ...
        try {
          ...
          console.log('WITH APOLLO COMPONENT FAILED ', error)
